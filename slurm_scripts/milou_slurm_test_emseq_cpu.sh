...
#SBATCH --job-name=milou_emseq_cpu
#SBATCH --output=logs/JD_milou_test_emseq_cpu_%j.out
#SBATCH --error=logs/JD_milou_test_emseq_cpu_%j.err
...
nextflow run main.nf \
    -profile test_emseq_cpu,singularity \
    --outdir results_test_emseq_cpu -resume
