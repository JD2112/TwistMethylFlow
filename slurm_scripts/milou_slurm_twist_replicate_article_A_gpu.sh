...
#SBATCH --job-name=MF_repl_A_gpu
#SBATCH --output=logs/JD_mf_twist_replicate_article_A_gpu_%j.out
#SBATCH --error=logs/JD_mf_twist_replicate_article_A_gpu_%j.err
